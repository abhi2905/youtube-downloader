...
class Google_Service_Vision_GoogleCloudVisionV1Block extends Google_Collection
{
  protected $collection_key = 'paragraphs';
  public $blockType;
  protected $boundingBoxType = 'Google_Service_Vision_GoogleCloudVisionV1BoundingPoly';
  protected $boundingBoxDataType = '';
  protected $paragraphsType = 'Google_Service_Vision_GoogleCloudVisionV1Paragraph';
  ...
  /**
   * @param Google_Service_Vision_GoogleCloudVisionV1Paragraph
   */
  ...
  /**
   * @return Google_Service_Vision_GoogleCloudVisionV1Paragraph
   */
