...
class Google_Service_Vision_GoogleCloudVisionV1FaceAnnotation extends Google_Collection
{
  protected $collection_key = 'landmarks';
  public $angerLikelihood;
  public $blurredLikelihood;
  protected $boundingPolyType = 'Google_Service_Vision_GoogleCloudVisionV1BoundingPoly';
  protected $boundingPolyDataType = '';
  public $detectionConfidence;
  protected $fdBoundingPolyType = 'Google_Service_Vision_GoogleCloudVisionV1BoundingPoly';
  protected $fdBoundingPolyDataType = '';
  public $headwearLikelihood;
  public $joyLikelihood;
  public $landmarkingConfidence;
  protected $landmarksType = 'Google_Service_Vision_GoogleCloudVisionV1FaceAnnotationLandmark';
   ...
   */
  public function setBoundingPoly(Google_Service_Vision_GoogleCloudVisionV1BoundingPoly $boundingPoly)
  {
   ...
   * @param Google_Service_Vision_GoogleCloudVisionV1BoundingPoly
   */
  public function setFdBoundingPoly(Google_Service_Vision_GoogleCloudVisionV1BoundingPoly $fdBoundingPoly)
  {
  ...
  /**
   * @param Google_Service_Vision_GoogleCloudVisionV1FaceAnnotationLandmark
   */
  ...
  /**
   * @return Google_Service_Vision_GoogleCloudVisionV1FaceAnnotationLandmark
   */
