...
class Google_Service_Vision_GoogleCloudVisionV1Page extends Google_Collection
{
  protected $collection_key = 'blocks';
  protected $blocksType = 'Google_Service_Vision_GoogleCloudVisionV1Block';
  ...
  /**
   * @param Google_Service_Vision_GoogleCloudVisionV1Block
   */
  ...
  /**
   * @return Google_Service_Vision_GoogleCloudVisionV1Block
   */
