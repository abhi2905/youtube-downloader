...
class Google_Service_Vision_GoogleCloudVisionV1WebDetection extends Google_Collection
{
  protected $collection_key = 'webEntities';
  protected $fullMatchingImagesType = 'Google_Service_Vision_GoogleCloudVisionV1WebDetectionWebImage';
  protected $fullMatchingImagesDataType = 'array';
  protected $pagesWithMatchingImagesType = 'Google_Service_Vision_GoogleCloudVisionV1WebDetectionWebPage';
  protected $pagesWithMatchingImagesDataType = 'array';
  protected $partialMatchingImagesType = 'Google_Service_Vision_GoogleCloudVisionV1WebDetectionWebImage';
  protected $partialMatchingImagesDataType = 'array';
  protected $visuallySimilarImagesType = 'Google_Service_Vision_GoogleCloudVisionV1WebDetectionWebImage';
  protected $visuallySimilarImagesDataType = 'array';
  protected $webEntitiesType = 'Google_Service_Vision_GoogleCloudVisionV1WebDetectionWebEntity';
  protected $webEntitiesDataType = 'array';

  /**
   * @param Google_Service_Vision_GoogleCloudVisionV1WebDetectionWebImage
   */
  ...
  /**
   * @return Google_Service_Vision_GoogleCloudVisionV1WebDetectionWebImage
   */
  ...
  /**
   * @param Google_Service_Vision_GoogleCloudVisionV1WebDetectionWebPage
   */
  ...
  /**
   * @return Google_Service_Vision_GoogleCloudVisionV1WebDetectionWebPage
   */
  ...
  /**
   * @param Google_Service_Vision_GoogleCloudVisionV1WebDetectionWebEntity
   */
  ...
  /**
   * @return Google_Service_Vision_GoogleCloudVisionV1WebDetectionWebEntity
   */
