...
class Google_Service_Vision_GoogleCloudVisionV1Word extends Google_Collection
{
  ...
  protected $symbolsType = 'Google_Service_Vision_GoogleCloudVisionV1Symbol';
  ...
  /**
   * @param Google_Service_Vision_GoogleCloudVisionV1Symbol
   */
  ...
  /**
   * @return Google_Service_Vision_GoogleCloudVisionV1Symbol
   */
